...
const HTMLVideoPlayer = React.forwardRef<HTMLVideoElement, HTMLVideoPlayerType>(
  (props: HTMLVideoPlayerType, ref: { current: HTMLVideoElement | null }) => {
    const { url } = props;
    ...
    return (
      <VideoPlayerSC className='d-flex'>
        <video ref={ref} muted>
