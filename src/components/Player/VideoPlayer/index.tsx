...
const VideoPlayer = React.forwardRef<HTMLVideoElement, IVideoPlayer>(
  (props, ref: React.RefObject<HTMLVideoElement>) => {
    ...
    return (
      <>
        ...
        {show &&
          createPortal(
            <HTMLVideoPlayer data-testid='video-player' ref={ref} sound={props.sound} url={props.url} />,
