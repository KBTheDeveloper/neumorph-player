      ...
      >
        <g className='speaker' id='speaker'>
          <rect
            ...
            height='143'
            rx='15'
            stroke='url(#paint0_linear_37_64)'
            strokeWidth='4'
          />
          <circle
            className='speaker__lf-inner'
            id='lf_inner'
            cx='46.5'
            cy='95.5'
            r='10.5'
          ...
          />
          <circle
            className='speaker__lf-outer'
            id='lf_outer'
            cx='46.5'
            cy='95.5'
            r='31'
            stroke='url(#paint1_linear_37_64)'
            strokeWidth='4'
          />
        ...
        <defs>
          <linearGradient id='paint0_linear_37_64' x1='46.5' y1='0' x2='46.5' y2='145' gradientUnits='userSpaceOnUse'>
            <stop stopColor='#813ECE'>
              <animate attributeName='stopColor' dur='2s' repeatCount='indefinite' values='#813ECE;#BB9ADF;#813ECE' />
            </stop>
            <stop offset='1' stopColor='#BB9ADF'>
              <animate attributeName='stopColor' dur='2s' repeatCount='indefinite' values='#BB9ADF;#813ECE;#BB9ADF' />
            </stop>
          </linearGradient>
