...
const RangeSlider = React.memo((props) => {
    ...
    return (React.createElement(RangeSliderSC, { "data-testid": 'range-slider', tabIndex: '0', onKeyDown: onKeyDown, theme: props.theme, id: `slider-${props.view}`, onWheel: onWheel, className: `range-slider ${viewsStyle[props.view]}
      ${themes[props.color]}`, style: { height: defaultParams.height, width: defaultParams.width }, ref: sliderRef },
        React.createElement("div", { className: 'range-slider__base', onClick: onClick },
            React.createElement("div", { className: 'range-slider__process-line', style: processLineFill }),
            React.createElement("div", { className: 'range-slider__origin', style: position },
                React.createElement("div", { onMouseDown: onMouseDown, className: 'range-slider__thumb' })))));
});
