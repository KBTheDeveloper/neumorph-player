...
const ButtonSC = styled.button((props) => ({
    "&.button": {
        ...
        "&:focus": {
            ...mixins.neuMorphismShadow("inset -4px -4px 8px rgba(255, 255, 255, 0.06)", "inset 4px 4px 8px rgba(255, 255, 255, 0.06)"),
        },
        "&--white": {
...
export const Button = React.forwardRef((props, ref) => {
    ...
    const buttonTemplate = props.href ? (React.createElement("a", { style: { color: appPalette[props.color] }, href: String(props.href), className: classes }, props.text)) : (React.createElement(ButtonSC, { tabIndex: '0', color: props.color, disabled: props.disabled, className: classes, type: props.type, id: props.id, onClick: onClick },
        props.icon && (React.createElement("svg", { width: props.icon.width, height: props.icon.height, viewBox: props.icon.viewBox },
            React.createElement("rect", { fill: props.color, width: '100%', height: '100%' }),
            React.createElement("path", { d: props.icon.path }))),
        props.text,
        props.children));
    return React.createElement(React.Fragment, null, buttonTemplate);
});
